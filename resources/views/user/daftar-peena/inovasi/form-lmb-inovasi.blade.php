      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-mb-12">
          ...
          <form action="{{url('sipeena/store-form-lmb-inovasi')}}" name="form1" method="post" enctype="multipart/form-data">
            ...
            <table width="100%">
              <tr>
                <td width="20%" height="45px" valign="top">Nama Penanggung Jawab <small>
                    <font color="red">*</font>
                  </small></td>
                ...
                <td width="20%" height="45px" valign="top">Nama Lembaga <small>
                    <font color="red">*</font>
                  </small></td>
                <td width="30%" height="45px" valign="top">
                  <input name="nama_lembaga" value="{{old('nama_lembaga')}}" class="form-control" style="padding: 3px 3px; border-radius: 15px;" type="text" required>
                  @error('nama_lembaga')
                  <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </td>
              ...
              <tr>
                ...
                <td width="20%" height="45px" valign="top">KTP Penanggung Jawab (.jpg) <small>
                    <font color="red">*</font>
                  </small></td>
                <td width="30%" height="45px" valign="top">
              ...
              <tr>
                ...
                <td width="30%" height="45px" valign="top">
                  <textarea name="alamat" class="form-control" style="padding: 3px 3px; border-radius: 15px;" rows="3" cols="30" required>{{old('alamat')}}
                </textarea>
                  @error('alamat')
                  <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
