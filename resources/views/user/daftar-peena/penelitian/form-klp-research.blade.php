      ...
      <div class="contact-form">
        <div class="container">
          ...
          <div class="row">
			  ...
			  <form action="sv-kelompok-research.php" name="form1" method="post" enctype="multipart/form-data">
	<table width="100%">
		<tr>
		...
		<tr>
            ...
            <button name="simpan_klp" type="submit" class="btn btn-common btn-effect">Simpan</button>
