...
<div class="col col-lg-12 col-md-12 bg-home">
    <section id="features" class="section ">
        <table id="dbOpdInovasi" class="table" style="width: 100%;">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Judul</th>
...
<script type="text/javascript">
    ...
    //Inovasi
    $(function() {
        var table = $('#dbOpdInovasi').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            ajax: "{{ route('home.getDbOpdInovasi') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
    ...
    $('body').on('click', '#showDbOpdInovasi', function(event) {
