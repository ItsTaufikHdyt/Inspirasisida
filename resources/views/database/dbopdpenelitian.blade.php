...
<div class="col col-lg-12 col-md-12 bg-home">
    <section id="features" class="section ">
        <table id="dbOpdPenelitian" class="table" style="width: 100%;">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Judul</th>
                            ...
                            <div class="col-lg-12 ">
                                <table class="table table-striped table-lg">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-left" width="30%"><b>Opd</b></td>
                                            <td id="opd"></td>
                                        </tr>
                                        <tr>
...
<script type="text/javascript">
    ...
    //Inovasi
    $(function() {
        var table = $('#dbOpdPenelitian').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            ajax: "{{ route('home.getDbOpdPenelitian') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
    ...
    $('body').on('click', '#showDbOpdPenelitian', function(event) {

        event.preventDefault();
        var id = $(this).data('id');
        console.log(id)
        $.get('{{url("showdbopdinovasi")}}' + '/' + id, function(data) {
            console.log(data);
